...
External detectors which output a `geometry_msgs/PoseArray` can easily be integrated into our framework using the scripts from [this package](/detection/spencer_pose_array_conversion). Examples of such detectors include:
