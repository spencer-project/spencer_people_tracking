...
External detectors which output a `geometry_msgs/PoseArray` can easily be integrated using the scripts in [this package](/detection/spencer_pose_array_conversion). Examples of such detectors include:
