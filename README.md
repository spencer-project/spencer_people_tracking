...
The packages in the `spencer_people_tracking` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -y --unsafe -t kinetic -r kinetic spencer_people_tracking` on `Fri, 12 May 2017 18:02:58 -0000`
...
## spencer_people_tracking (kinetic) - 1.0.2-0
